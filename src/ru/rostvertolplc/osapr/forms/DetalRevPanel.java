 ...
 // java.util.Timer timer;
  ...
  public void renderData()
  {
    ...
    if (data.sc==null)
    {
      ...
      // Данный Event включает в себя edMassa.setText, edMassa.setEnabled
      chbFromModel_actionPerformed(new ActionEvent(chbFromModel, 0, "Set"));
    }
    else
    {
    ...
    chbVR3_p.setSelected(data.vr3_s);
    chbVR3_s.setSelected(data.vr3_p);
...
*/
    ...
    cbControl.addItem("");
    for (int i=0; i<data.lov_control.length; i++) {  cbControl.addItem(data.lov_control[i]); }
    cbControl.setSelectedItem(data.vr6_vid);
    // Формат
    cbFormat.addItem("");
    for (int i=0; i<data.lov_format.length; i++) {  cbFormat.addItem(data.lov_format[i]); }
    cbFormat.setSelectedItem(data.format);
    cbNameProc.addItem("");//Наименование процесса
    for(int i=0; i<vremennoIdPr.length; i++)   {  cbNameProc.addItem(vremennoIdPr[i]);}
*/
    // Тип изготовления
...
//      data.code_dse = edCodeDSE.getText();
     ...
     //data.vr10_tex_pas = edVR10_TechPas.getText();
      ...
      data.vr3_s = chbVR3_s.isSelected();
      data.vr3_p = chbVR3_p.isSelected();
      data.vr3_note = edVR3_Note.getText();
...
*/
      ...
      data.vr6_vid = cbControl.getSelectedItem()==null ? "" : cbControl.getSelectedItem().toString();
      */
...
//	            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(20, 5, 5, 5), 0, 0));
...
//	            ,GridBagConstraints.SOUTHWEST, GridBagConstraints.HORIZONTAL, new Insets(20, 5, 5, 5), 0, 0));
	    ...
	    jPanel1.add(jLabel9, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 5, 5), 0, 0));
	    ...
	    }
	    {
	    	...
	    	jPanel1.add(jTextField1, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 5, 0), 0, 0));
	    }
	    ...
	    /////////////////////
	    MainPanel.add(new JLabel("Извещение"),        new GridBagConstraints(0, 12, 2, 1, 0.0, 0.0
	            ,GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 0), 0, 0));
	    MainPanel.add(edChangeNotice,         new GridBagConstraints(1, 12, 1, 1, 0.0, 0.0
	            ,GridBagConstraints.SOUTHWEST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 0), 0, 0));
	    ...
	    MainPanel.add(edType,              new GridBagConstraints(1, 0, 2, 1, 0.0, 0.0
	            ,GridBagConstraints.SOUTHWEST, GridBagConstraints.HORIZONTAL, new Insets(20, 5, 5, 0), 0, 0));
	    ...
	    //MainPanel.add(cbTypeIzgot,                             new GridBagConstraints(2, 9, 2, 1, 0.0, 0.0
	    ...
	    //MainPanel.add(dateVnedrII,                                      new GridBagConstraints(2, 5, 2, 1, 0.0, 0.0
	   ...
	   // MainPanel.add(edChangeNotice,                                                         new GridBagConstraints(1, 6, 4, 1, 0.0, 0.0
		         //   ,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 5, 5, 0), 0, 0));
...
//	            ,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(10, 5, 5, 0), 0, 0));
	    MainPanel.add(edIndication,                                                                                                                                      new GridBagConstraints(1, 1, 5, 1, 0.0, 0.0
	            ,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 5, 5, 0), 0, 0));
...
//	            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 5, 0), 0, 0));
	    ...
	    MainPanel.add(dateChange,                                                                                     new GridBagConstraints(1, 5, 2, 1, 0.0, 0.0
	            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 5, 0), 0, 0));
	    MainPanel.add(LNotSaved, new GridBagConstraints(3, 13, 2, 1, 0.0, 0.0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(20, 0, 0, 0), 0, 0));
	    {
	    	jLabel4 = new JLabel();
	    	MainPanel.add(jLabel4, new GridBagConstraints(3, 13, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
	    ...
	    jpMilx.add(jpMaterial, new GridBagConstraints(2, 6, 4, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 0, 0, 0), 0, 0));
	    ...
	    jpSignOffs.add(LReviewer,                         new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0
	            ,GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE, new Insets(0, 5, 5, 5), 0, 0));
...
//	            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
	  ...
	  /*  jpRascex.add(edRascex, new GridBagConstraints(0, 1, 3, 1, 1.0, 0.0
	            ,GridBagConstraints.SOUTHWEST, GridBagConstraints.HORIZONTAL, new Insets(0, 20, 30, 0), 0, 0));
	    jpRascex.add(cbCexa, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0
	            ,GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE, new Insets(0, 5, 30, 20), 0, 0));
	    jpRascex.add(jLabel29,  new GridBagConstraints(0, 0, 2, 1, 0.0, 0.0
	            ,GridBagConstraints.SOUTH, GridBagConstraints.NONE, new Insets(50, 20, 5, 0), 0, 0));
	    jpRascex.add(jLabel30, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0
	            ,GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE, new Insets(0, 5, 5, 20), 0, 0));
	    jpRascex.add(jLabel32, new GridBagConstraints(0, 3, 1, 1, 0.0, 1.0
	            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
	    ...
	    jpVR.add(jpVR18,            new GridBagConstraints(0, 2, 1, 1, 1.0, 1.0
	            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(10, 10, 5, 10), 0, 0));
	 ...
	 */
	    ...
	    infoKart.add(cbNameProc,     new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0
	            ,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 55, 0));
...
//    String s = "";
    try{
      ...
      if (item.getType().equals("Материал"))
      {
        ...
        {
          edNameMat.setText(form.getFormTCProperty("MIL_NAME_DSE").getStringValue());
          edNDMark.setText(form.getFormTCProperty("MIL_ND_MARKA").getStringValue());
          edNDSort.setText(form.getFormTCProperty("MIL_ND_SORT").getStringValue());
          edMarkMat.setText(form.getFormTCProperty("MIL_MARKA_MAT").getStringValue());
          edVidZagot.setText(form.getFormTCProperty("MIL_VID_ZAGOT").getStringValue());
          edMatShifr.setText(form.getFormTCProperty("MIL_DSE_CODE").getStringValue());
          edDensity.setText(form.getFormTCProperty("MIL_MASSA").getStringValue());
        }
        //setNameSpec();
      }
      else
