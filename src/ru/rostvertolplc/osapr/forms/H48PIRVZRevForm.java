...
//	if (itemType.equals("Деталь Revision Master")) innpaneDetalRev.saveToUserData();
//	if (itemType.equals("Сб. единица Revision Master")) innpaneSbEdRev.saveToUserData();
//	if (itemType.equals("Материал Revision Master")) innpaneMaterialRev.saveToUserData();
//	if (itemType.equals("Документ Revision Master")) innerPanelDocument.saveToUserData();
//	if (itemType.equals("Комплекс Revision Master")) innerPanelKompleks.saveToUserData();
//	if (itemType.equals("Комплект Revision Master")) innerPanelKomplekt.saveToUserData();
//	if (itemType.equals("Прочее Revision Master")) innerPanelProchee.saveToUserData();
//	if (itemType.equals("Стандартное изд. Revision Master")) innerPanelStd_izd.saveToUserData();
...
/*    
    else if (sFormType.equals("Дет.Норм. Revision Master"))
    {
      innerPanel = new DetalRevPanel(data);
      //innerPanel.setHeader("Нормализованная Деталь - Модификация");
    }
    else if (sFormType.equals("СЕ Норм. Revision Master"))
    {
      innerPanel = new SbEdRevPanel(data);
      //innerPanel.setHeader("Нормализованная Сб. единица - Модификация");
    }
    else if (sFormType.equals("Комплекс Revision Master"))
    {
      innerPanel = new ComplexRevPanel(data);
      //innerPanel.setHeader("Комплекс - Модификация");
    }
    else if (sFormType.equals("Тех. узел Revision Master"))
    {
      innerPanel = new SbEdRevPanel(data);
