...
public class ProcheeItemPanel extends JPanel implements InterfaceFormPanel {
	...
	public void renderData() {
		...
		edNProtocol.setText(data.n_protraz);
		dtProtocol.setDate(data.date_protocol);
		...
		LUtil.fillComboBoxLOV(icbTipIzgot, asTipIzgot);
		icbTipIzgot.setSelectedItem(data.type_izgot);
	...
	public void saveToUserData() {
		try {
			...
			data.n_protraz = edNProtocol.getText();
			data.date_protocol = dtProtocol.getDate();
